...
#BSP:modify lcm driver CEQCEB-4 by cheng.wang 20200422 start
BOOT_LOGO = hdplus1640
#BSP:modify lcm driver CEQCEB-4 by cheng.wang 20200422  end
BUILD_AGO_GMS = no
BUILD_KERNEL = yes
BUILD_LK = yes
BUILD_MD32 = no
...
CUSTOM_BUILD_VERNO = CY-CE7-H693-C
...
CUSTOM_HAL_IMGSENSOR = ov64b40_mipi_raw s5k3p9sp_mipi_raw gc02m1b_mipi_raw gc02m1_mipi_raw gc6153_serial_yuv pblcov64b40_mipi_raw pblcs5k3p9sp_mipi_raw pblcgc02m1b_mipi_raw pblcgc02m1_mipi_raw pblcgc6153_serial_yuv
CUSTOM_HAL_MAIN2_IMGSENSOR = gc02m1b_mipi_raw
CUSTOM_HAL_MAIN_IMGSENSOR = ov64b40_mipi_raw
CUSTOM_TRAN_HAL_MAIN3_IMGSENSOR = gc02m1_mipi_raw
CUSTOM_TRAN_HAL_MAIN4_IMGSENSOR = gc6153_serial_yuv
#ITD:modify by camera driver team end
#BSP: add CEQCEB-2 by zhigang.yang for 20200422 start
CUSTOM_HAL_MSENSORLIB = mmc5603_ce7
#BSP: add CEQCEB-2 by zhigang.yang for 20200422 end
...
#BSP: add CEQCEB-2 by zhigang.yang for 20200422 end
#ITD:modify by camera driver team start
CUSTOM_KERNEL_IMGSENSOR = ov64b40_mipi_raw s5k3p9sp_mipi_raw gc02m1b_mipi_raw gc02m1_mipi_raw gc6153_serial_yuv
#ITD:modify by camera driver team end
...
#TSD:modify config dir CEQCEB-1 by baoxin.he 20200415 start
CUSTOM_MODEM = ce7_h693_c1
#TSD:modify config dir CEQCEB-1 by baoxin.he 20200415 end
...
#BSP:modify audio bring up CEQCEB-6 yong.guo 20200424 start
MTK_AUDIO_NUMBER_OF_MIC = 1
#BSP:modify audio bring up CEQCEB-6 yong.guo 20200424 end
...
MTK_BWC_SUPPORT = yes
#TSD:modify CEQCEB-1 by baoxin.he 20200424 start
MTK_C2K_LTE_MODE = 0
#TSD:modify CEQCEB-1 by baoxin.he 20200424 end
MTK_CAMERA_APP = no
...
#ITD:add cam 3pty function by yu.wang 2020511 start
MTK_CAM_HDR_SUPPORT = no
#ITD:add cam 3pty function by yu.wang 2020511 end
...
#SDD: modify CEQCEB-20 by jiangping.guo 20200430 start
MTK_CTA_SET = no
#SDD: modify CEQCEB-20 by jiangping.guo 20200430 end
MTK_CTA_SUPPORT = no
MTK_CTM_SUPPORT = no
...
#BSP:modify jeita function XLJLHLJY-1249 by yongqing.dou 20191211 start
MTK_JEITA_STANDARD_SUPPORT = yes
#BSP:modify jeita function XLJLHLJY-1249 by yongqing.dou 20191211 end
MTK_K64_SUPPORT=yes
...
#TSD: modify XLBSHLJSHH-6 zhaopeng 20200509 end
#BSP:modify for fast charger XLJLHLJY-5 by yongqing.dou 20191104 start
...
#BSP:modify for fast charger XLJLHLJY-5 by yongqing.dou 20191104 end
...
#BSP: add CEQCEB-2 by zhigang.yang for 20200422 end
CUSTOM_TRAN_PROJECT=tran_ce7
CUSTOM_TRAN_BOM=tran_ce7_c1
MTK_BUILD_VERNO=CE7-H693CD-Q-GL-201201V390
TRAN_FINGERPRINT_BUILD_VERNO=201201V390
